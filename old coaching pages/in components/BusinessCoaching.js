...
import businesscoachingimg from "../assets/images/business-coaching.png"
      ...
      <div className="container">
        ...
        <div className="container">
          ...
          <div className="container bootstrap snippets bootdeys">
                  ...
                  <div className="timeline-centered timeline-sm">
                          ...
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-right">
                                <Link to="/professional-scrum-product-owner/">
                                    <img src={pspo} alt="pspo" className="timeline-img-dimensions"/>
                                </Link>  
                          ...
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-left">
                                  <Link to="/professional-scrum-master/">
                                    <img src={psm} alt="psm" className="timeline-img-dimensions"/>
                                    </Link>
                                </div>
                          ...
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-right">
                                  <Link to="/professional-scrum-product-owner-advanced/">
                                    <img src={pspoa} alt="pspo advance" className="timeline-img-dimensions"/></Link></div>     
                      ...
                      <article className="timeline-entry">
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-right">
                              <Link to="/professional-scrum-with-user-experience/">
                                  
                                    <img src={psu} alt="psu" className="timeline-img-dimensions"/></Link></div>
                      ...
                      <article className="timeline-entry">
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-right">
                                <Link to="icagile-product-management/">
                                    <img src={icppdm} alt="icppdm" className="timeline-img-dimensions"/>
                                </Link>
                              </div>      
                          ...
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-left">
                                  <Link to="applying-metrics-for-predictabilityapm/">
                                    <img src={amp} alt="apk" className="timeline-img-dimensions"/>
                                  </Link>
                              </div>
                              {/* <div className="timeline-label-left bg-green"><h4 className="timeline-title">Job Meeting</h4>
                              <p>Caulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette.</p></div> */}
                      ...
                      <article className="timeline-entry">
                          <div className="timeline-entry-inner">
                              ...
                              <div className="timeline-img-pos-right"><img src={pspo3} alt="pspo 3" className="timeline-img-dimensions"/></div>
                              {/* <div className="timeline-label-left bg-green"><h4 className="timeline-title">Job Meeting</h4>
                              <p>Caulie dandelion maize lentil collard greens radish arugula sweet pepper water spinach kombu courgette.</p></div> */}
                          </div>
                      </article>
            ...
            {/* <img src={businesscoachingimg} class="img-fluid" alt="Business-Coaching image" />
            <img src={contentimg} class="img-fluid" alt="Business-Coaching image" /> */}
