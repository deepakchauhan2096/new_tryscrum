            ...
            <div className="row">
                ...
                <div className="course-details__content">
                  ...
                  <br /> */}
                      <p className="course-details__tab-text makingblack">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.thecourse }} />
                      </p>

                      <p className="course-details__tab-text makingblack" >
                        <h2 style={{ color: "red" }}>Certificate</h2>
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.certificate }} />
                      </p>

                      <p className="course-details__tab-text makingblack" >
                        <h2 style={{ color: "red" }}>Why tryScrum</h2>
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.why }} />
                      </p>
                      ...
                      <p className="course-details__tab-text makingblack" >
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.feeStructure }} />
                      </p>

                      <ul className="list-unstyled course-details__tab-text makingblack" >
                        <h2 style={{ color: "red" }}>Virtual class Instructions</h2>
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.instructions }} />
                        <li>
                    ...
                    <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                      ...
                      <p className="course-details__tab-text makingblack" >
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.curriculum }} />
                      </p>
                      <br />
                    ...
                    <div className="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                      ...
                      <p className="makingblack">
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.whoCanAttend }} />
                      </p>
                      <br />
              ...
              <a href="#none" className="thm-btn course-details__price-btn">
                Buy This Course
                  ...
                  <button onClick={() => goToFaq()} className="thm-btn course-details__price-btn hide_mobile" >
                    FAQ'S
                  </button>
                </div>
                ...
                <div className="course-details__meta" >
                  ...
                  <div className="course-details__meta-link" style={{ padding: "10px" }}>
                    <span>
                      <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.options.included }} />
                    </span>
                  </div>
              ...
              {course.acfcoursePage.faq1.heading === "" ? "" :
                <div>
                  <h2 style={{ color: "black", marginTop: "10px" }} ref={faqRef}>Frequently Asked Questions</h2>
                  <div style={{ display: 'inline-block' }} >
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingOne">
                      <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq1.heading }} />
                      </button>
                    </h2>
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        {/* The registration fee includes the fees for classroom training, the study material, exam fees. */}
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq1.content }} />
                      </div>
                    </div>
                  </div>
                }
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwo">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq2.heading }} />
                      </button>
                    </h2>
...
For other Courses, please speak to our support executive by writing to <a href="mailto help@tryscrum.com"> help@tryscrum.com </a>
       */}
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq2.content }} />
                      </div>
                    </div>
                  </div>
                }
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingThree">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq3.heading }} />
                      </button>
                    </h2>
       ...
       */}
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq3.content }} />
                      </div>
                    </div>
                  </div>
                }
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingFour">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq4.heading }} />
                      </button>
                    </h2>
      ...
      */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq4.content }} />
                      </div>
                    </div>
                  </div>
                }
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingFive">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq5.heading }} />
                      </button>
                    </h2>
       ...
       */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq5.content }} />
                      </div>
                    </div>
                  </div>
                }
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingSix">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq6.heading }} />
                      </button>
                    </h2>
       ...
       */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq6.content }} />
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingSeven">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq7.heading }} />
                      </button>
                    </h2>
       ...
       */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq7.content }} />
                      </div>
                    </div>
                  </div>
                }
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingEight">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq8.heading }} />
                      </button>
                    </h2>
       ...
       */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq8.content }} />
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingNine">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq9.heading }} />
                      </button>
                    </h2>
       ...
       */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq9.content }} />
                ...
                {course.acfcoursePage.faq10.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq10.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq10.content }} />
                ...
                {course.acfcoursePage.faq11.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingEleven">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq11.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq11.content }} />
                ...
                {course.acfcoursePage.faq12.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwelve">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq12.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq12.content }} />
                ...
                {course.acfcoursePage.faq13.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingThirteen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen" aria-expanded="false" aria-controls="collapseThirteen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq13.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq13.content }} />
                ...
                {course.acfcoursePage.faq14.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingFourteen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourteen" aria-expanded="false" aria-controls="collapseFourteen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq14.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq14.content }} />
                ...
                {course.acfcoursePage.faq15.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingFifteen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFifteen" aria-expanded="false" aria-controls="collapseFifteen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq15.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq15.content }} />
                ...
                {course.acfcoursePage.faq16.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingSixteen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixteen" aria-expanded="false" aria-controls="collapseSixteen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq16.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq16.content }} />
                ...
                {course.acfcoursePage.faq17.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingSeventeen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeventeen" aria-expanded="false" aria-controls="collapseSeventeen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq17.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq17.content }} />
                ...
                {course.acfcoursePage.faq18.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingEighteen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEighteen" aria-expanded="false" aria-controls="collapseEighteen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq18.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq18.content }} />
                ...
                {course.acfcoursePage.faq19.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingNineteen">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNineteen" aria-expanded="false" aria-controls="collapseNineteen">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq19.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq19.content }} />
                ...
                {course.acfcoursePage.faq20.heading === "" ? "" :
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwenty">
                      <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwenty" aria-expanded="false" aria-controls="collapseTwenty">
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq20.heading }} />
                      </button>
                    </h2>
                  ...
                  */}
                        ...
                        <div dangerouslySetInnerHTML={{ __html: course.acfcoursePage.faq20.content }} />
