...
class CourseEnrollTable extends React.Component {
  ...
  renderMessages() {
    ...
    // filtered = this.state.filteredval;
    // const removeAllfromcountry = newfilteredData.country.includes('ALL') === false;
    const removeAllfromcountry = newfilteredData.filter((post) => {
      // console.log(newfilteredData, "popopop")
      return post.country.includes('ALL') === false;
    })

    console.log(removeAllfromcountry, "removeall")

    const filteredcountry = removeAllfromcountry.map((data => data.country))

    const countryList = [...new Set(filteredcountry)]

    console.log(filteredcountry, "countryList")
    // let countryList = removeAllfromcountry.filter((c, index) => {
    //   return removeAllfromcountry.indexOf(c) !== index;
    // });
      ...
      <>
        ...
        {filtered  == 0 ? "" : <center className="desktopdisplay">
          ...
          <div className="centered">
            {/* <button type="button" className="btn btn-card" checked style={{ border: "1px solid black", color: "black", marginLeft: "10px", backgroundColor: this.state.button1 }} onClick={OnlinePlusOffline}>All</button>
              <button type="button" className="btn btn-card" style={{ border: "1px solid black", color: "black", marginLeft: "10px", backgroundColor: this.state.button2 }} onClick={filterOnline}>Online</button>
              <button type="button" className="btn btn-card" style={{ border: "1px solid black", color: "black", marginLeft: "10px", backgroundColor: this.state.button3 }} onClick={filterOffline}>Offline</button> */}
            <select
            ...
            <button
              ...
              onClick={(event) => HandleCountry(event, 1)}
              value="online"
              name={this.state.value}
            ...
            {/* <i class="fa fa-filter" style={{ marginLeft: "10px" }}></i> */}
       ...
       {filtered == 0 ? "" : <center className="tabletdisplay">
        ...
        <div className="tabletdisplay">
          {this.state.currenttableview.length >= 1 ?
            ...
            </Carousel> : <div>{filtered < 1 ? <>
              <div id="closet" className="modal-overlay">
                <div className="popupbox">

                  <a className="close" href="#closet" ><button
                    type="search"
                    style={{ background: "none", border: "none" }}
                    onClick={(event) => HandleLocation(event, 3)}
                    value="all"
        ...
        {/* {filtered.length > 0 ?
          <center class="mobiledisplay">
            <div class="btn-group">
              <button type="button" className="btn btn-card" checked style={{ border: "1px solid black", color: "black", marginLeft: "4px", backgroundColor: this.state.button1 }} onClick={OnlinePlusOffline}>All</button>
              <button type="button" className="btn btn-card" style={{ border: "1px solid black", color: "black", marginLeft: "4px", backgroundColor: this.state.button2 }} onClick={filterOnline}>Online</button>
              <button type="button" className="btn btn-card" style={{ border: "1px solid black", color: "black", marginLeft: "4px", backgroundColor: this.state.button3 }} onClick={filterOffline}>Offline</button>
            </div></center> : null} */}
        ...
        <div className="mobiledisplay">
          {this.state.currenttableview.length >= 1 ?
            <Carousel itemsToShow={1} showArrows={false} disableArrowsOnEnd={true} enableAutoPlay={false} autoPlaySpeed={2300} >
              {this.state.currenttableview.map((filtered) => (
                <div className="card-container"  >
            ...
            : <div>{filtered < 1 ? <>
              <div id="closem" className="modal-overlay">
                <div className="popupbox">

                  <a className="close" href="#closem" ><button
                    type="search"
                    style={{ background: "none", border: "none" }}
                    onClick={(event) => HandleLocation(event, 3)}
                    value="all"
